...
router.get("/", checkAuthenticated_1.checkAuthenticated, category_1.getInfoOfCategories, category_1.renderCategoryPage);
router.get("/create", category_1.renderCreateCategoryPage);
router.post("/create", category_1.getInfoOfCategories, category_1.checkCreatingCategory, category_1.createCategory);
